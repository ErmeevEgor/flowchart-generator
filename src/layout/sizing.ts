import type { Bounds, ProcessNode } from "../model/processModel.js";
...
export const DEFAULT_SIZING: SizingOptions = {
  minWidth: 176,
  maxWidth: 264,
...
export function measureNode(node: ProcessNode, options: SizingOptions = DEFAULT_SIZING): MeasuredNode {
  ...
  if (metadataLines.length > 0) height += 10 + metadataLines.length * options.metadataLineHeight;
