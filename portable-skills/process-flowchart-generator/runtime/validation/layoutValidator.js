...
export function segmentIntersectsRect(a, b, rect, gap = 0) {
...
function warning(code, message, elements) {
    const diagnostic = { severity: "warning", code, message };
    if (elements)
        diagnostic.elements = elements;
    return diagnostic;
}
//# sourceMappingURL=layoutValidator.js.map